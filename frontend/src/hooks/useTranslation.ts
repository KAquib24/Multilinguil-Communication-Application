...
export const useTranslation = () => {
   ...
   */
  const startLiveTranslation = useCallback((callId: string) => {
    if (translationSocket) {
      translationSocket.startTranslation(callId, targetLanguage, sourceLanguage);
    } else {
   ...
   */
  const stopLiveTranslation = useCallback((callId: string) => {
    if (translationSocket) {
   ...
   */
  const sendAudioChunk = useCallback((callId: string, audioChunk: string | Buffer) => {
    if (translationSocket) {
   ...
   */
  const changeLiveTranslationLanguage = useCallback((callId: string, newTargetLanguage: string) => {
    if (translationSocket) {
